...
class ClosedPositionScreen extends StatefulWidget {
  @override
  _ClosedPositionScreenState createState() => _ClosedPositionScreenState();
}

class _ClosedPositionScreenState extends State<ClosedPositionScreen> {
